...
GRANT USAGE ON SCHEMA SWIGGY.BRONZE TO ROLE KAFKA_CONNECTOR_ROLE;

-- Allow Kafka to insert data
GRANT INSERT ON ALL TABLES IN SCHEMA SWIGGY.BRONZE TO ROLE KAFKA_CONNECTOR_ROLE;

-- Future tables safety
GRANT INSERT ON FUTURE TABLES IN SCHEMA SWIGGY.BRONZE TO ROLE KAFKA_CONNECTOR_ROLE;
...
-- REVOKE ROLE SYSADMIN FROM USER KAFKA_CONNECT_USER;
