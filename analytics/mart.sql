...
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DIM_CUSTOMER
--     FOREIGN KEY (DIM_CUSTOMER_ID)
--     REFERENCES GOLD.DIM_CUSTOMER (CUSTOMER_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DIM_CUSTOMER_ADDRESS
--     FOREIGN KEY (DIM_CUSTOMER_ADDRESS_ID)
--     REFERENCES GOLD.DIM_CUSTOMER_ADDRESS (CUSTOMER_ADDRESS_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DIM_RESTAURANT
--     FOREIGN KEY (DIM_RESTAURANT_ID)
--     REFERENCES GOLD.DIM_RESTAURANT (RESTAURANT_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DIM_RESTAURANT_LOCATION
--     FOREIGN KEY (DIM_RESTAURANT_LOCATION_ID)
--     REFERENCES GOLD.DIM_RESTAURANT_LOCATION (RESTAURANT_LOCATION_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DIM_MENU
--     FOREIGN KEY (DIM_MENU_ID)
--     REFERENCES GOLD.DIM_MENU (DIM_MENU_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_FACT_DELIVERY_AGENT
--     FOREIGN KEY (FACT_DELIVERY_AGENT_ID)
--     REFERENCES GOLD.FACT_DELIVERY_AGENT (DELIVERY_AGENT_HK);

-- ALTER TABLE GOLD.ORDER_ITEM_FACT
--     ADD CONSTRAINT FK_ORDER_ITEM_FACT_DELIVERY_DIM_DATE
--     FOREIGN KEY (ORDER_DATE_KEY)
--     REFERENCES GOLD.DIM_DATE (DIM_DATE_HK);