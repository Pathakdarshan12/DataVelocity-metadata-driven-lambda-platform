...
INSERT INTO DATAVELOCITY.common.data_file_format (
...
-- Order ID field
INSERT INTO DATAVELOCITY.common.data_field (
    file_format_id, field_name, field_position, field_data_type,
    field_length, is_nullable, description, validation_rules
) SELECT
    (SELECT file_format_id FROM DATAVELOCITY.common.data_file_format WHERE file_format_name = 'orders_csv'),
...
INSERT INTO DATAVELOCITY.common.data_field (
    ...
    (SELECT file_format_id FROM DATAVELOCITY.common.data_file_format WHERE file_format_name = 'customers_json'),
...
INSERT INTO DATAVELOCITY.common.data_field (
    ...
    (SELECT file_format_id FROM DATAVELOCITY.common.data_file_format WHERE file_format_name = 'customers_json'), 'last_name', 'STRING',
...
-- Order ID mapping
INSERT INTO DATAVELOCITY.common.database_column_mapping (
    ...
    (SELECT df.data_field_id FROM DATAVELOCITY.common.data_field df
     JOIN DATAVELOCITY.common.data_file_format ff ON df.file_format_id = ff.file_format_id
...
INSERT INTO DATAVELOCITY.common.data_file_data_format (file_format_id, data_field_id, field_order, is_required_in_file, is_included_in_load)
SELECT
    ff.file_format_id,
    df.data_field_id,
    df.field_position,
...
JOIN DATAVELOCITY.common.data_field df ON ff.file_format_id = df.file_format_id
WHERE ff.file_format_name = 'orders_csv';

-- ===== STEP 7: Add Data Quality Rules =====

INSERT INTO DATAVELOCITY.common.data_quality_rules (
...
SELECT * FROM DATAVELOCITY.common.vw_complete_field_mapping
WHERE file_format_name = 'orders_csv'
ORDER BY source_field_name;

-- Show file processing configuration
SELECT * FROM DATAVELOCITY.common.vw_file_processing_config;